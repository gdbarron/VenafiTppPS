...
FunctionsToExport = 'Find-TppCertificate', 'Find-TppObject', 'Get-TppAttribute', 
               ...
               'Get-TppLog', 'Get-TppPermission', 'Get-TppWorkflowDetail', 
               'Move-TppObject', 'New-TppCapiApplication', 'New-TppCertificate', 
               'New-TppPolicy', 'New-TppSession', 'Remove-TppCertificate', 
...
AliasesToExport = 'ConvertTo-TppDN', 'Get-TppObject'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- BREAKING CHANGE: Break out basic certificate gathering from Get-TppCertificateDetail into Find-TppCertificate
