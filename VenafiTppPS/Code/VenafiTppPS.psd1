...
@{
    ...
    FunctionsToExport = 'Find-TppCertificate', 'Find-TppObject', 'Get-TppAttribute',
    'Get-TppCertificate', 'Get-TppCertificateDetail',
    'Get-TppCustomField', 'Find-TppIdentity', 'Get-TppIdentityAttribute',
    'Get-TppLog', 'Get-TppPermission', 'Get-TppWorkflowTicket',
    ...
    'Set-TppWorkflowTicketStatus', 'Test-TppIdentity', 'Test-TppObject', 'Get-TppObject'
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = '- Rename Get-TppWorkflowDetail to Get-TppWorkflowTicket and add InputObject pipeline support
