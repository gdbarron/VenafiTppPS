...
FunctionsToExport = 'Get-TppAttribute', 'Get-TppCertificateDetail', 'Get-TppCustomField', 
               ...
               'Get-TppWorkflowDetail', 'Move-TppObject', 'New-TppCapiApplication', 
               'New-TppCertificate', 'New-TppPolicy', 'New-TppSession', 
               'Rename-TppObject', 'Restore-TppCertificate', 'Revoke-TppCertificate', 
               'Set-TppAttribute', 'Set-TppWorkflowStatus', 'Test-TppObject'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- add status filters to Get-TppCertificateDetail, all filters added
