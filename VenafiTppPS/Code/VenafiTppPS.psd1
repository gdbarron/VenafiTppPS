...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- moved New-TppObject from private to public and updated to allow new objects to be created across all classes whether a custom function exists or not
