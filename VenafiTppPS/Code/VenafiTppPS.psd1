...
AliasesToExport = 'ConvertTo-TppDN', 'Get-TppWorkflowDetail', 'Get-TppIdentity', 'fto', 'ftc', 'itcr'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '- fix session state not being preserved across internal function calls, thanks Kory B!
